...
public:
  ...
  void set_disp_min(int32_t val) {param.disp_min = val;}
  void set_disp_max(int32_t val) {param.disp_max = val;}
  void set_support_threshold(float val) {param.support_threshold = val;}
  void set_support_texture(int32_t val) {param.support_texture = val;}
  void set_candiate_stepsize(int32_t val) {param.candidate_stepsize = val;}
  void set_incon_window_size(int32_t val) {param.incon_window_size = val;}
  void set_incon_threshold(int32_t val) {param.incon_threshold = val;}
  void set_incon_min_support(int32_t val) {param.incon_min_support = val;}
  void set_add_corners(bool val) {param.add_corners = val;}
  void set_grid_size(int32_t val) {param.grid_size = val;}
  void set_beta(float val) {param.beta = val;}
  void set_gamma(float val) {param.gamma = val;}
  void set_sigma(float val) {param.sigma = val;}
  void set_sradius(float val) {param.sradius = val;}
  void set_match_texture(int32_t val) {param.match_texture = val;}
  void set_lr_threshold(int32_t val) {param.lr_threshold = val;}
  void set_speckle_sim_threshold(float val) {param.speckle_sim_threshold = val;}
  void set_speckle_size(int32_t val) {param.speckle_size = val;}
  void set_ipol_gap_width(int32_t val) {param.ipol_gap_width = val;}
  void set_filter_median(bool val) {param.filter_median = val;}
  void set_filter_adaptive_mean(bool val) {param.filter_adaptive_mean = val;}
  void set_postprocess_only_left(bool val) {param.postprocess_only_left = val;}
  void set_subsampling(bool val) {param.subsampling = val;}
  int32_t get_disp_min() {return param.disp_min;}
  int32_t get_disp_max() {return param.disp_max;}
  float get_support_threshold() {return param.support_threshold;}
  int32_t get_support_texture() {return param.support_texture;}
  int32_t get_candidate_stepsize() {return param.candidate_stepsize;}
  int32_t get_incon_window_size() {return param.incon_window_size;}
  int32_t get_incon_threshold() {return param.incon_threshold;}
  int32_t get_incon_min_support() {return param.incon_min_support;}
  bool is_add_corners() {return param.add_corners;}
  int32_t get_grid_size() {return param.grid_size;}
  float get_beta() {return param.beta;}
  float get_gamma() {return param.gamma;}
  float get_sigma() {return param.sigma;}
  float get_sradius() {return param.sradius;}
  int32_t get_match_texture() {return param.match_texture;}
  int32_t get_lr_threshold() {return param.lr_threshold;}
  float get_speckle_sim_threshold() {return param.speckle_sim_threshold;}
  int32_t get_speckle_size() {return param.speckle_size;}
  int32_t get_ipol_gap_width() {return param.ipol_gap_width;}
  bool is_filter_median() {return param.filter_median;}
  bool is_filter_adaptive_mean() {return param.filter_adaptive_mean;}
  bool is_postprocess_only_left() {return param.postprocess_only_left;}
  bool is_subsampling() {return param.subsampling;}
